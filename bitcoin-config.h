...
#define COPYRIGHT_HOLDERS "The %s Clone developers"

/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Bitcoin Core Clone developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Bitcoin Core Clone"
...
#define PACKAGE_NAME "Bitcoin Core Clone"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Bitcoin Core Clone 21.99.0"
